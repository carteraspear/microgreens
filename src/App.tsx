...
import { FaHome, FaPen, FaStar, FaEnvelope, FaComment, FaShare, FaArrowLeft } from "react-icons/fa"; // Import missing icons

function App() {
  const [activeTab, setActiveTab] = useState("Neighbors");
  const [showProfile, setShowProfile] = useState(false); // New state for the user's profile page
    ...
    <div className="app-container">
      ...
      <div className="top-bar">
        <div
          ...
          onClick={() => setShowProfile(true)} // Navigate to profile page
      ...
      <main className="content">
        {showProfile ? (
          <UserProfilePage onBack={() => setShowProfile(false)} /> // Show profile page with back button
        ) : (
          <>
      ...
      {/* Green Circle */}
      {!showProfile && <div className="green-circle">↓</div>}
    ...
    <div className="user-profile-page">
      ...
      <div className="profile-content">
        ...
        <div className="activity">
          <h3>My Posts</h3>
          <p>See your recent activity here.</p>
        </div>
      </div>
    </div>
  );
...
function NeighborsPage() {
  ...
  const loadNeighbors = () => {
    ...
    const newNeighbors = Array.from({ length: 9 }, (_, index) => ({
      ...
      profileImage: "https://via.placeholder.com/60", // Placeholder profile image
    }));
